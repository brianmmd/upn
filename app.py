...
def login(username, password):
    # untuk mengautentikasi agar bisa login
    if username == "TEKNIKMESIN22" and password == "UPNVJT22":  
...
# Fungsi untuk menampilkan dashboard lokomotif
def show_lokomotif_dashboard():
...
# Fungsi untuk menampilkan dashboard lokasi
def show_lokasi_dashboard():
...
# Fungsi untuk menampilkan dashboard data
